            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-2">
                    <div class="panel panel-default"
                        style="background: rgba(255, 255, 255, 0.15); border-radius: 15px; border: 1px solid rgba(255,255,255,0.3); box-shadow: 0 8px 32px rgba(31,38,135,0.37); backdrop-filter: blur(8px); -webkit-backdrop-filter: blur(8px);">
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="size">Type/Size</label>
                                <input type="text" name="size" class="form-control" id="size" value="AVSS 2.0 SQ 37/0.260"
                                    readonly>
                            </div>
                            ...
                            <div id="label_lot_not" class="form-group">
                                ...
                                <input type="number" name="lot_not" value="" class="form-control" id="lot_not"
                                    placeholder="Lot No (ex: 001)" required>
                            </div>
                    ...
                    <div class="panel panel-default"
                        ...
                        <div class="panel-body">
                            ...
                            <div id="label_bobin_no" class="form-group">
                                ...
                                <input type="text" name="bobin_no" value="" class="form-control" id="bobin_no"
                                    placeholder="No Bobin" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <button type="submit" class="btn btn-primary btn-block" style="background:#0284c7 !important;
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <form class="form-inline" style="gap:0.5rem;">
                                    ...
                                    <a href="{{ route('web.dashboard.index') }}" class="btn btn-success btn-sm" style="background:#16a34a;
                                              border:none;
                                              border-radius:6px;
                                              padding:0.4rem 1rem;
                                              font-weight:500;
                                ...
                                <div class="table-responsive" style="border-radius:8px;
                                    ...
                                    <table class="table table-striped table-bordered" style="margin:0;
                                        ...
                                        <tbody>
                                            @forelse ($labels as $index => $label)
                                                <tr>
                                                    ...
                                                    <td class="text-center" style="white-space: nowrap;">
                                                        ...
                                                        <button title="Hapus" data-action="delete"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="11" class="text-center" style="color:#475569;">Tidak ada label
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
